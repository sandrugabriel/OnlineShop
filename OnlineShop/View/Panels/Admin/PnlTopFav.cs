...
namespace OnlineShop.View.Panels.Admin
{
    public class PnlTopFav : Panel
    {
        ...
        public PnlTopFav(Form1 form1)
        {
            ...
            listFrecventa = favouriteComandService.frecventaMaxi();

            listNume = productComandService.numeTop(favouriteComandService.frecventa());
...
/*
            ...
            this.pctDesign1.Size = new System.Drawing.Size(290, 2);
            ...
            this.lblProd.Text = "Top Favourites";
